(function() {
    ...
    var StringCaseMatch = typeof require === 'function' ? require('../string-case-match') : window.StringCaseMatch;
    ...
    describe('StringCaseMatch.match', function() {
        ...
        it('Highlights matching parts of string', function() {
            expect(new StringCaseMatch(['Hello-World'], { start: '<i>', end: '</i>' }).matches('hellWo'))
                .toEqual(['<i>Hell</i>o-<i>Wo</i>rld']);
